Citizen.CreateThread(function()
	for _, v in pairs(interiors) do
		SetupInterior(v.coords, v.props)
	end
end)

function SetupInterior(coords, props)
	for _, coords in pairs(coords) do
...
local interiors = {	
	...
	--FIB building.. idk what these do
	{
		interiorsProps = {
			"V_FIB03_door_light",
			"V_FIB02_set_AH3b",
